...
public enum ActionEnum {
    MOVETOCART, //TODO: Write general description for this element
    SAVEFORLATER; //TODO: Write general description for this element

    private static TreeMap<String, ActionEnum> valueMap = new TreeMap<String, ActionEnum>();
    private String value;

    static {
        MOVETOCART.value = "MoveToCart";
        SAVEFORLATER.value = "SaveForLater";

        valueMap.put("MoveToCart", MOVETOCART);
        valueMap.put("SaveForLater", SAVEFORLATER);
    }
